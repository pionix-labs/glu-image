...
class GluImage
{
     ...
     */
    protected function getAnimatedGif($imgFilePath)
    {
    ...
    public function get($imgFile)
    {
        ...
        if ($this->isAnimatedGif) {
            $this->frames = $this->getAnimatedGif($imgFile);
        } else {
     ...
     * @return [type]                 [description]
     */
    protected function resize($width = null, $height = null, $aspectRatio = true, $preventUpsize = true)
    {
        $this->imgFileRes->resize(
            $width,
            $height,
     ...
     * @return [type]         [description]
     */
    protected function resizeAnimated($width = null, $height = null)
    {
     ...
     * @return [type]         [description]
     */
    protected function crop($width, $height, $x = null, $y = null)
    {
     ...
     * @return [type]         [description]
     */
    protected function cropAnimated($width, $height, $x = null, $y = null)
    {
        $framesProcessed = array();
        foreach ($this->frames as $frame) {
            $this->imgFileRes = $this->interImage->make($frame['image']);
